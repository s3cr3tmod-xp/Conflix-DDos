...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            print()
            log_message(f"\033[48;5;3m\033[38;5;0Ip Address\033[0m\033[33m•> {ip} \033[93mPort:\033[37m•> {port} \033[36msent •> {sent} \033[94mthreads\033[38;5;220m•> {threading.get_ident()}\r")
            log_message(f"\033[38;5;220mIp Address\033[94m•> {ip} \033[32port\033[31m•> {port} \033[36msent•> {sent} \033[93mnum\033[37m•> {rate_limit}\r")
