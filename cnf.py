...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            log_message(f"\033[38;5;220mIp Address\033[38;5;7m•> {ip} \033[3mport:\033[0m\033[37m{port}\033[0m \033[94mSent•> \033[31m{sent} \033[3mpacket_size\033[0m\033[37m•> {packet_size}")
