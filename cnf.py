...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            log_message(f"\033[38;5;220m\033[3mIp Address\033[38;5;154m•> {ip} \033[3mport:\033[0m\033[37m{port}\033[0m \033[32mSent•> \033[38;5;206m{sent} \033[3mpacket_size\033[0m\033[37m •> .. {packet_size}")
