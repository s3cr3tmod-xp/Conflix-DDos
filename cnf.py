...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            log_message(f"\033[48;5;3m\033[30mIp Address\033[0m\033[37m•> {ip} \033[3mport:\033[0m\033[96m{port} \033[36mSent•> \033[37m{sent} \033[94mthreads\033[38;5;220m•> {threading.get_ident()}")
            log_message(f"\033[38;5;220mIp Address\033[38;5;39m•> {ip} \033[3mport:\033[0m\033[37m{port}\033[0m \033[94mSent•> \033[31m{sent} \033[93mpacket_size\033[37m•> {packet_size}")
